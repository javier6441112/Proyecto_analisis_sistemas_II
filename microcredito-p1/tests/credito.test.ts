...
describe('ciclo de vida de credito', () => {
  ...
  it('rechaza pagos para creditos solicitados y rechazados', () => {
    ...
    expect(() => solicitado.registrarPago(Dinero.de('100.00'), 0, Dinero.cero(), fechaPrueba)).toThrow(/Pago rechazado/);
  ...
  it('conserva la marca al salir de reestructurado mediante un pago', () => {
    ...
    credito.registrarPago(Dinero.de('100.00'), 0, Dinero.cero(), fechaPrueba);
  ...
  it('cancela al agotar el capital e impide operar estados terminales', () => {
    const credito = creditoDesembolsado();
    credito.registrarPago(Dinero.de('10000.00'), 0, Dinero.cero(), fechaPrueba);
    ...
    expect(() => anulado.registrarPago(Dinero.de('10.00'), 0, Dinero.cero(), fechaPrueba)).toThrow(/Pago rechazado/);
  });
